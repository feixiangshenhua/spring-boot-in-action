package com.nari.guangzhou.dicp.dicpwsserver.server;

import com.nari.guangzhou.dicp.dicpwsserver.config.CustomSpringConfigurator;
...
@Slf4j
@Component
@ServerEndpoint(value = "/dicp-ws/{userId}", configurator = CustomSpringConfigurator.class)
