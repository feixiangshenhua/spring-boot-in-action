...
import com.dicp.sse.DicpSseServerApplicationTests
import com.dicp.sse.client.SseClient
...
class SseEmitterEndpointTest extends DicpSseServerApplicationTests {
    ...
    void testConnect() {
        ...
        def connectUrl = "http://127.0.0.1:${port}/dicp-sse/api/v1/channel/${userId}/connect"
    ...
    void listAllConnections() {
        def list = RestAssured.given()
                ...
                .log().all()
                .get("http://127.0.0.1:${port}/dicp-sse/api/v1/channel/list")
                .then()
    ...
    void testGetUserCount() {
        def count = RestAssured.given()
                .contentType(ContentType.APPLICATION_JSON.toString())
                .log().all()
                .get("http://127.0.0.1:${port}/dicp-sse/api/v1/channel/count")
                .then()
                .log().all().statusCode(HttpStatus.OK.value())
    ...
    void createUserInfo() {
        ...
        RestAssured.given()
                ...
                .body(userBaseInfo)
                .log().all()
                .post("http://127.0.0.1:${port}/dicp-sse/api/v1/channel/${userId}/info")
                .then()
    ...
    void testClose() {
        RestAssured.given()
                .contentType(ContentType.APPLICATION_JSON.toString())
                .log().all()
                .delete("http://127.0.0.1:${port}/dicp-sse/api/v1/channel/${userId}/close")
                .then()
